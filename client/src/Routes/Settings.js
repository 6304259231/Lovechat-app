...
function Settings({ setLogin }) {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    axios.put('http://localhost:5600/update-profile', updateUser, {
      headers: {
        'Authorization': localStorage.getItem('jwt'),
      },
    }).then((response) => {
    ...
    <center>
      <div className="card mb-4 mt-4 setting-section" style={{ width: "50%" , borderRadius : '12px'}}>
        <div className='profile-image'>
          <img src={user.avatar || "https://i.pinimg.com/236x/38/aa/95/38aa95f88d5f0fc3fc0f691abfaeaf0c.jpg"} className="card-img-top" alt="..." style={{ borderRadius: '50%', border: '4px inset tomato' }} />
