...
let port = 5600;
let uri = "mongodb+srv://vishnumothukuru:Vittuvishnujob123@cluster0.1ewxygz.mongodb.net/Love_chat?retryWrites=true&w=majority";
let app = express();
...
app.post('/sendchat', verifyToken, async (request, response) => {
    try {
        ...
        if (exists) {
            ...
            // response.status(200).json({ message : 'posted succefully'})
